...
function Controller() {
  ...
  const [messages, setMessages] = useState<any[]>([]) // Store any objects as an array

  // Recieve stream of data from backend and convert data to audio
  ...
  // when person stops recording, send the recording to the backend
